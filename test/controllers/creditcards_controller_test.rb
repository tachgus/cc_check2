...
class CreditcardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create creditcard" do
    assert_difference('Creditcard.count') do
      post creditcards_url, params: { creditcard: { card_number: @creditcard.card_number, card_type: @creditcard.card_type } }
    end
  ...
  test "should update creditcard" do
    patch creditcard_url(@creditcard), params: { creditcard: { card_number: @creditcard.card_number, card_type: @creditcard.card_type } }
